...
sidebar:
    nav: Blog
---
Prof. Shusen Wang at the Stevens Institute of Technology provided [a short but informative tutorial](https://www.youtube.com/watch?v=hE7eGew4eeg) for few-shot learning and metric learning. I took lecture notes and complemented this tutorial with additional materials and code built on PyTorch.
